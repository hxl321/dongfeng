...
<div style="  display: flex;flex-direction: row;  justify-content: flex-start;flex-wrap: wrap;" >  
  ...
  <van-col span="20" style="margin-left: 0.2rem; margin-top: 0.2rem;text-align:left ;padding-left:0.2rem" @click="itemClick(item)"  v-for="(item ) in historyData" :key = 'item'>{{item}}</van-col>
